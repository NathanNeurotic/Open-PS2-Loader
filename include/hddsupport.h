...
// Resolve a relative file path inside the already-selected live APA data home. This may load/mount
// the normal HDD support stack, but never selects or mounts an arbitrary partition.
