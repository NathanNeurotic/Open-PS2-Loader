...
#include "iLinkman.h"
#include "include/iLink_internal.h"
...
{
    /* Use a static valid Sony OUI EUI-64 GUID (08:00:46) and standard model name
       to avoid importing cdvdman (sceCdRI/sceCdRM), which is absent in POPSTARTER. */
    *guid = 0x0800460123456789ULL;
    memcpy(ModelName, "SCPH-39000", 11);
    return 0;
}
...
#ifdef USE_CUSTOM_ILINKMAN_MALLOC_AND_FREE
