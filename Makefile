...
FRONTEND_OBJS = pad.o xparam.o fntsys.o renderman.o menusys.o OSDHistory.o system.o lang.o lang_internal.o config.o hdd.o dialogs.o \
		...
		appsupport.o mmcesupport.o favsupport.o vcdsupport.o gui.o guigame.o vmc_groups.o textures.o opl.o atlas.o nbns.o httpclient.o gsm.o cheatman.o sound.o ps2cnf.o
...
IOP_OBJS =	iomanx.o filexio.o ps2fs.o usbd.o bdmevent.o \
		...
		ps2dev9.o smsutils.o ps2ip.o smap.o smap_udpbd.o isofs.o nbns-iop.o \
...
PNG_ASSETS = load0 load1 load2 load3 load4 load5 load6 load7 usb usb_bd ilk_bd \
	...
	Index_0 Index_1 Index_2 Index_3 Index_4 fav fav_mark R3 L3
